...
%               2. Replicates full algorithm to calibrate series. 
%      
% IMPORTANT: Make sure to download the databases from the shared drive. Read the README file for more details.
%
